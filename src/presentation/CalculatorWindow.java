...
import businesslogic.CommissionCalculator;
import businesslogic.Currency;
import businesslogic.ForexOperator;
...
public class CalculatorWindow extends JFrame {
	...
	/**
	 * Creates the frame of the Currency Exchange Calculator.
	 */
	/**
	 * 
	 */
	public CalculatorWindow() {
		...
		logoLabel.setIcon(new ImageIcon("./images/Bank_Logo.png"));
